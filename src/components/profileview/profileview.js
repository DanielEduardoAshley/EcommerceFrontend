        ...
        <div className="w3-white">
         ...
         <br></br>
           <div className="w3-half">
             <img src="/w3images/lights.jpg" style={{"width" :"100%"}} className="w3-margin-bottom"></img>
           </div>
           <div className="w3-half">
           ...
           <div className="w3-half">
             <img src="/w3images/snow.jpg" style={{"width" :"100%"}} className="w3-margin-bottom"></img>
           </div>
         </div>
          </div>
        </div>      
      ...
      <div className="w3-container w3-card w3-white w3-round w3-margin"><br></br>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          <div className="w3-row-padding" style={{"margin" :"0 -16px"}}>
            <div className="w3-half">
              <img src="/w3images/lights.jpg" style={{"width" :"100%"}} alt="Northern Lights" className="w3-margin-bottom"></img>
            </div>
            <div className="w3-half">
